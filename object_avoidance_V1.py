        ...
        while True:
            ...
            if (Gx or Gy or Gz) < 1:
                if (Gx or Gy or Gz) > -1:
                    ...
                    # If left sensor distance < 40 cm, then:
                    if distance1 < 40:
                        print("Turning Right")
                    ...
                    # if right sensor < 40 cm then:          
                        ...
                        p2.start(20)           
                        break	
                    # if both sensors > 40 cm then:		
                    else:
                        print("Moving Forwards")
                        # both motors drive forwards at same speed
                        GPIO.output(DIG1, GPIO.LOW)          
                        GPIO.output(DIG2, GPIO.LOW)          
                        p1.start(100)                        
                        p2.start(100)                        
                        break
                # if gyro reading < -1 then: 
                else:
