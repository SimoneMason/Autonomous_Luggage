...
This version includes 3 ultrasonic sensors, instead of the original two. 
The pins for Ultrasonic Sensor 3 will need to be chosen as the current ones are placeholders
'''
