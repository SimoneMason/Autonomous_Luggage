...
while True:
    ...
    try:
        while True:
            ...
            if (Gx or Gy or Gz) < 2 and (Gx or Gy or Gz) > 0:
                ...
                # If left distance sensor < 40 and right distance sensor >= 40
                    ...
                    p1.start(20 * multiplier)                     
                    p2.start(100 * multiplier)
                ...
                # if right sensor < 40 cm then:          
                    ...
                    GPIO.output(DIG1, GPIO.HIGH)		
                    GPIO.output(DIG2, GPIO.LOW)		
                    p1.start(100 * multiplier)			
                    p2.start(20 * multiplier)           
                    break	
